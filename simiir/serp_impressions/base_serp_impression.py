...
class BaseSERPImpression(object):
    ...
    """
    def __init__(self, search_context, topic, patch_type_threshold=0.6):
        """
    ...
    def _calculate_patch_type(self, snippet_judgements=None):
        ...
        Stephen and Krebs (1986), Section 8.3. To calculate how good the SERP is judged to appear, the area under the gain curve is calculated.
        This is done via integration along the y axis using the composite trapezoidal rule.
        
        If the normalised area (with respect to a perfect gain curve, where gain is extracted from every document) is equal to or above
