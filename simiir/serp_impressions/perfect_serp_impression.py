...
class PerfectSERPImpression(BaseSERPImpression):
    ...
    """
    def __init__(self, search_context, topic, qrel_file, viewport_size=10, patch_type_threshold=0.4):
    ...
    def get_impression(self):
        ...
        for i in range(0, goto_depth):
            ...
            trec_judgement = self.__qrel_handler.get_value_if_exists(self._topic.id, results_list[i].docid)
